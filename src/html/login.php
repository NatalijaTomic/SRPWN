              ...
              <div class="card-body">
                ...
                <form>
                  ...
                  <div class="d-flex align-items-center justify-content-between mb-4">
                    ...
                    <a class="text-primary fw-bold" href="./index.html">Zaboravljena lozinka</a>
                  </div>
                  <a href="./index.html" class="btn btn-primary w-100 py-8 fs-4 mb-4 rounded-2">Sign In</a>
                  <div class="d-flex align-items-center justify-content-center">
                    <p class="fs-4 mb-0 fw-bold">Nemate nalog?</p>
                    <a class="text-primary fw-bold ms-2" href="./authentication-register.html">Napravite nalog.</a>
                  </div>
                </form>
              </div>
            </div>
